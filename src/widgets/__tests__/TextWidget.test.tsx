...
describe('TextWidget', () => {
    ...
    it('displays label from uiSchema', () => {
        render(<TextWidget {...defaultProps} uiSchema={{ 'ui:title': 'UI Schema Label' }} />);
    ...
    it('displays help text from uiSchema', () => {
        render(<TextWidget {...defaultProps} uiSchema={{ 'ui:help': 'UI help text' }} />);
        expect(screen.getByText('UI help text')).toBeInTheDocument();
    });

    it('displays help text from options', () => {
        render(<TextWidget {...defaultProps} options={{ help: 'Options help' }} />);
